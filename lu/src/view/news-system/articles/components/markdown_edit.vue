<template>
<div>
  <Modal v-model="modalShow" :closable='false' @on-cancel="cancel" :mask-closable=false width="70" class-name="article-modal">
    <p slot="header">修改</p>
    <Form ref="formData" :model="formData" :rules="rules" label-position="right" :label-width="100">
      <FormItem label="分类">
