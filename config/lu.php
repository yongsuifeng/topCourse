...
switch ($envValue) {
    case 'production':
        $returnArray['accept_other_host'] =
            [
                'common' => [ // 访问 AcceptCommonAccessController
                    'hosts' => [
                        'http://lucmsee_api.com',
                    ],
                    'access_token' => 'xccvxcvxKMSDFYIIadfN*&^%$#@~~!',
                ],
                'lucmsee_api' => [ // 访问  AcceptLucmseeApiAccessController
        ...
        $returnArray['access_other_host'] =
            [
                'filesystem' => [
                    'host' => 'http://filesystem.com',
                    'access_token' => 'kjsdfiyYnsdfsadfYkT@#$',
                ]
            ];
        $returnArray['today_top_article_category_id'] = 11;// 今日头条分类 id
        $returnArray['my_article_category_id'] = 12;// 我的文章分类 id
        break;
    case 'testing':
        break;
    default:
